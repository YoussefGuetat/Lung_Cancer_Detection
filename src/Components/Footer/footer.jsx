...
const Footer = () => {
  return (
    <section className="py-0 bg-secondary">
      <div className="bg-holder opacity-25" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/assets/img/gallery/dot-bg.png)`, backgroundPosition: "top left", marginTop: "-3.125rem", backgroundSize: "auto"}}>
      </div>
      <div className="container">
        <div className="row py-8">
          <div className="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0">
            <a className="text-decoration-none" href="#"><img src={`${process.env.PUBLIC_URL}/assets/img/gallery/footer-logo.png`} height="51" alt="" /></a>
          ...
          <div className="row justify-content-md-between justify-content-evenly py-4">
            ...
            <div className="col-12 col-sm-8 col-md-6">
              <p className="fs--1 my-2 text-center text-md-end text-200"> Made with&nbsp;
                ...
                </svg>&nbsp;by&nbsp;<a className="fw-bold text-info" href="https://themewagon.com/" target="_blank" rel="noopener noreferrer">ThemeWagon </a>
              </p>
            </div>
          </div>
        </div>
